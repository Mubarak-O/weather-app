...
const ForecastWeather = ({ data }) => {
	...
	return (
		<div
			data-cy="forecast-weather"
			className="container flex flex-col max-w-4xl mx-auto bg-[#1C1C1E] rounded-t-2xl rounded-b-md p-3"
		>
			<h2 className="mt-2 ml-4 font-saira text-white text-2xl">
				Weekly Forecast
			</h2>
			<div
				data-cy="forecast-weather-main"
				className="scrollbar-container flex flex-row space-x-12 p-4 overflow-x-auto"
			>
